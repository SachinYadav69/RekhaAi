...
const HeroFirst = () => {
  return (
    <div className="bg-[#050201] text-[#ededed] selection:bg-orange-500/30 relative overflow-hidden min-h-screen">
      {/* Background Glow - Sabse piche (-z-10) */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-orange-900/20 via-[#050201] to-[#050201] -z-10"></div>
      ...
      {/* Main Content - Sabse upar (relative z-10) */}
      <main className="relative z-10 pt-20  px-6 flex flex-col items-center text-center">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-950/30 border border-orange-900/50 text-[11px] font-medium text-orange-300 mb-8 uppercase tracking-widest leading-none">
          <Sparkles size={12} className="text-orange-400" />
          Powered by AI
        </div>
        ...
        <div className="relative max-w-5xl">
          <h1 className="text-6xl md:text-8xl font-bold tracking-tighter mb-8 bg-gradient-to-b from-white to-zinc-600 bg-clip-text text-transparent leading-tight">
            The future is written <br /> in the stars.
          </h1>
        </div>
