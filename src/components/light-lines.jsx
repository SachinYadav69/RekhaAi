...
import { cn } from "../utils/utils"; // Path: src/utils/utils.js

export function LightLines({
  className,
  linesOpacity = 0.1, // Thoda badha diya taaki dikhe
  lightsOpacity = 0.9,
  speedMultiplier = 1,
  gradientFrom = "transparent", // Isko transparent rakha taaki tera glow dikhe
  gradientTo = "transparent",
  lightColor = "#f97316", // Orange theme
  lineColor = "#333", // Subtle lines
  children,
}) {
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "absolute inset-0 h-full w-full flex justify-center overflow-hidden z-0",
        className,
      )}
      style={{
